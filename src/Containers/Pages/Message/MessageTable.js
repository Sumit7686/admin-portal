...
function createData(Subject, Body, StartTime, EndTime, id, updatedAt, createdAt) {
  return {
    Subject,
    Body,
    StartTime,
    ...
    <Toolbar
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete">
          <IconButton onClick={() => props.multipleDelete(props.selected)}>
            <DeleteIcon />
          </IconButton>
        </Tooltip>
      ) : (
...
export default function MessageTable(props) {
  ...
  const rows = [
    createData(
      'Dine Around Sessions Start at 12:00PM!',
      'Dine Arounds are located around Downtown Colorado Springs...',
      '04-13 6:00AM',
      '04-14 3:00PM',
      '123123123123',
      '2022-05-11T11:30:26.328+00:00',
      '2022-05-11T11:30:26.328+00:00'
    ),
    createData(
      'Dine Around Sessions Start at 12:00PM!',
